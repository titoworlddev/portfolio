    ...
    const tarjetaAssets = {
      Programacion: {
        'Random X': {
          ...
          img: '/assets/img/trabajos/random_x/randomx-presentation.webp',
          coverImg: '/assets/img/trabajos/random-x.webp',
        ...
        Operit: {
          ...
          img: '/assets/img/trabajos/operit/operit-presentation.webp',
          coverImg: '/assets/img/trabajos/operit.webp',
          linkImg: '/assets/img/trabajos/store-badges/google-play-badge.svg',
      ...
      Diseno: {
        'Game Zone': {
          ...
          img: '/assets/img/trabajos/game_zone/game-zone-presentation.webp',
          coverImg: '/assets/img/trabajos/game-zone-store.webp',
        ...
        'El Chingón': {
          ...
          img: '/assets/img/trabajos/el_chingon/el-chingon-presentation.webp',
          coverImg: '/assets/img/trabajos/el-chingon.webp',
          linkImg: '/assets/img/trabajos/store-badges/instagram-logo.svg',
          url: 'https://www.instagram.com/cristian_am91/'
        },
        "L'evasion": {
          ...
          img: '/assets/img/trabajos/levasion/levasion-presentation.webp',
          coverImg: '/assets/img/trabajos/levasion.webp',
          linkImg: '/assets/img/trabajos/store-badges/instagram-logo.svg',
          url: 'https://www.instagram.com/cristian_am91/'
        }
      }
